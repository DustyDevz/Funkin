...
#include <shader/shader_types.hpp>
#include <ui/ui_theme.hpp>
#include "d3d12_ui.hpp"
#include "d3d12_text.hpp"
...
namespace Funkin::UI {
    ...
    void UIRenderer::pushQuad(Math::Rect r, Math::Color color,
    ...
    void UIRenderer::pushLine(Math::Vec2 a, Math::Vec2 b, Math::Color color, float thickness) {
        float dx = b.x - a.x;
        float dy = b.y - a.y;
    ...
    void UIRenderer::drawFilledRect(Math::Rect r, Math::Color color) {
        pushQuad(r, color, 0.0f, 0.0f, 1.0f, 1.0f, false);
    }

    void UIRenderer::drawRect(Math::Rect r, Math::Color fill, Math::Color border,
    ...
    void UIRenderer::drawLine(Math::Vec2 a, Math::Vec2 b, Math::Color color, float thickness) {
        pushLine(a, b, color, thickness);
    }

    void UIRenderer::drawCircle(Math::Vec2 center, float radius, Math::Color color, int segments) {
        ensureBatch(false);
        auto& batch = m_batches.back();
    ...
    void UIRenderer::drawSprite(Renderer::GAL::TextureHandle tex,
                                Math::Rect dest, Math::Color tint) {
        pushQuad(dest, tint, 0.0f, 0.0f, 1.0f, 1.0f, false);
    }

    void UIRenderer::drawText(const std::string& text, Math::Rect bounds, Math::Color color,
    ...
    void UIRenderer::drawRoundedRect(Math::Rect r, Math::Color fill, float radius) {
